...
<div class="container">
<c:forEach items="${product_Gallery}" var="prod">
 <div class="col-sm-6">
<div class="card" style="width:300px; float:left;">
     <img class="card-img-top img-responsive img-fluid" src="${pageContext.request.contextPath }/resources/${prod.imageUrl }" alt="Card image" style="width:100%">
     <div class="card-body">
	  <center>
      <h4 class="card-title">${prod.productname}</h4>
      <p style="color:black"class="card-text">${prod.description }</p>
      <a href="ps4pro" style="border-radius:0px;" class="btn btn-primary">Add 2 Cart</a>
      </center>
	</div>
  </div>
  </div>
